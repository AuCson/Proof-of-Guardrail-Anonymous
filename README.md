...
4. Launch all Vsock proxies and inject a version of the Openclaw into the enclave. 
...
```
python verify_attestation.py --file ../examples/attestation_quote_example.json
```
